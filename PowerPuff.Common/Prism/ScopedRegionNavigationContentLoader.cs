...
{
    /// <summary>
    /// Reference: https://app.pluralsight.com/library/courses/prism-mastering-tabcontrol/table-of-contents
    /// </summary>
    public class ScopedRegionNavigationContentLoader : IRegionNavigationContentLoader
    {
        ...
        private bool CreateRegionManagerScope(object view)
        {
            ...
            var viewHasScopedRegion = view as ICreateRegionManagerScope;
            if (viewHasScopedRegion != null)
            {
                createRegionManagerScope = viewHasScopedRegion.CreateRegionManagerScope;
            }
